...
(defun lisatiy/rename-file-and-buffer ()
...
(defun lisatiy/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun lisatiy/dired-do-command (command)
...
(defun lisatiy/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun lisatiy/insert-space-after-point ()
  (interactive)
