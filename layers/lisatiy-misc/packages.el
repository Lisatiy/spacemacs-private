...
(defun lisatiy-misc/post-init-popup ()
  (use-package popup
    :config
    (progn
...
(defun lisatiy-misc/init-lispyville ()
...
(defun lisatiy-misc/post-init-chinese-conv ()
...
(defun lisatiy-misc/init-browse-at-remote ()
  (use-package browse-at-remote
    :defer t
    :init (spacemacs/set-leader-keys "gho" 'browse-at-remote)))

(defun lisatiy-misc/init-highlight-global ()
...
(defun lisatiy-misc/post-init-symbol-overlay ()
...
(defun lisatiy-misc/post-init-golden-ratio ()
...
(defun lisatiy-misc/post-init-ranger ()
...
(defun lisatiy-misc/init-helm-ag ()
  (use-package helm-ag
    :defer t
    :init
    (progn
...
(defun lisatiy-misc/post-init-gist ()
  (use-package gist
    :defer t
    :init
...
(defun lisatiy-misc/init-peep-dired ()
...
(defun lisatiy-misc/post-init-flyspell-correct ()
  (progn
    (with-eval-after-load 'flyspell
      (define-key flyspell-mode-map (kbd "C-;") 'flyspell-correct-previous))
    (setq flyspell-correct-interface 'flyspell-correct-ivy)))

(defun lisatiy-misc/post-init-smartparens ()
...
(defun lisatiy-misc/init-tiny ()
  (use-package tiny
    :defer t
    :init
    (spacemacs/set-leader-keys "oe" 'tiny-expand)))

(defun lisatiy-misc/post-init-helm ()
...
(defun lisatiy-misc/init-helm-github-stars ()
  (use-package helm-github-stars
    :commands (helm-github-stars)
    :init
    (setq helm-github-stars-username "lisatiy")))




(defun lisatiy-misc/post-init-fcitx ()
  (fcitx-aggressive-setup))

(defun lisatiy-misc/post-init-command-log ()
...
(defun lisatiy-misc/init-litable ()
  (use-package litable
    :init
    :defer t))

(defun lisatiy-misc/init-osx-dictionary ()
...
(defun lisatiy-misc/init-4clojure ()
...
(defun lisatiy-misc/post-init-avy ()
  (progn
    (global-set-key (kbd "C-s-'") 'avy-goto-char-2)
    (global-set-key (kbd "M-'") 'avy-goto-char-2)))

(defun lisatiy-misc/post-init-ace-window ()
  (global-set-key (kbd "C-x C-o") #'ace-window))

(defun lisatiy-misc/init-discover-my-major ()
...
(defun lisatiy-misc/post-init-elfeed ()
  (use-package elfeed
    :init
    ...
    (progn
      ...
      (defun lisatiy/elfeed-mark-all-as-read ()
        (interactive)
        (mark-whole-buffer)
        (elfeed-search-untag-all-unread))

      (define-key elfeed-search-mode-map (kbd "R") 'lisatiy/elfeed-mark-all-as-read)
...
(defun lisatiy-misc/post-init-evil ()
  (progn
    ...
    (define-key evil-normal-state-map
      (kbd "Y") 'lisatiy/yank-to-end-of-line)
    ...
    (define-key evil-visual-state-map (kbd "C-r") 'lisatiy/evil-quick-replace)
    ...
    ;; (defadvice evil-insert-state (around lisatiy/holy-mode activate)
...
(defun lisatiy-misc/init-visual-regexp ()
  (use-package visual-regexp
    :commands (vr/replace vr/query-replace)))

(defun lisatiy-misc/init-visual-regexp-steroids ()
...
(defun lisatiy-misc/init-multiple-cursors ()
...
;;; Occasionally useful
    ...
    (setq mc/cmds-to-run-once
          '(
            counsel-M-x
            lisatiy/my-mc-mark-next-like-this))
...
(defun lisatiy-misc/post-init-persp-mode ()
  (setq persp-kill-foreign-buffer-behaviour 'kill)
  (setq persp-lighter nil)

  (defun lisatiy-kill-other-persp-buffers (&optional arg)
...
(defun lisatiy-misc/post-init-pyim ()
  (progn
    ...
    ;; 设置极点五笔可以参考https://github.com/lisatiy/rime-wubi86-jidian  
    (eval-and-compile
...
;; deprecated
(defun lisatiy-misc/post-init-chinese-wbim ()
  (progn
...
(defun lisatiy-misc/post-init-evil-escape ()
  (setq evil-escape-delay 0.2))

(defun lisatiy-misc/init-find-file-in-project ()
...
(defun lisatiy-misc/post-init-projectile ()
  (progn
  ...
  current project. Otherwise do `occur' in the current file."
    ...
    (spacemacs/set-leader-keys "pf" 'lisatiy/open-file-with-projectile-or-counsel-git)
    (spacemacs/set-leader-keys "pt" 'my-simple-todo)))



(defun lisatiy-misc/post-init-prodigy ()
  (progn
    (prodigy-define-tag
      :name 'jekyll
    ...
    ;;   (call-interactively 'lisatiy/browser-refresh--chrome-applescript))
...
(defun lisatiy-misc/init-moz-controller ()
...
(defun lisatiy-misc/init-ag ()
  (use-package ag
    :init))

(defun lisatiy-misc/post-init-erc ()
  (progn
    (add-hook 'erc-text-matched-hook 'my-erc-hook)
    (spaceline-toggle-erc-track-off)))

(defun lisatiy-misc/init-wrap-region ()
...
(defun lisatiy-misc/init-keyfreq ()
  (use-package keyfreq
    :init
    (progn
      (keyfreq-mode t)
...
(defun lisatiy-misc/post-init-swiper ()
...
(defun lisatiy-misc/post-init-magit ()
  (progn
    ...
    (eval-after-load 'magit
      '(define-key magit-mode-map (kbd "C-c g")
         #'lisatiy/magit-visit-pull-request))

    (setq magit-process-popup-time 10)))

(defun lisatiy-misc/post-init-git-messenger ()
  (use-package git-messenger
    :defer t
    :config
    (progn
      (define-key git-messenger-map (kbd "f") 'lisatiy/github-browse-commit))))

(defun lisatiy-misc/post-init-markdown-mode ()
  (progn
