;;; packages.el --- lisatiy-ui layer packages file for Spacemacs.
;;
...
(defun lisatiy-org/post-init-evil-org ()
...
(defun lisatiy-org/post-init-org-pomodoro ()
  (lisatiy/pomodoro-notification))

;;In order to export pdf to support Chinese, I should install Latex at here: https://www.tug.org/mactex/
;; http://freizl.github.io/posts/2012-04-06-export-orgmode-file-in-Chinese.html
;;http://stackoverflow.com/questions/21005885/export-org-mode-code-block-and-result-with-different-styles
(defun lisatiy-org/post-init-org ()
...
See `org-capture-templates' for more information."
      ...
      (defvar lisatiy-website-html-preamble
        "<div class='nav'>
<ul>
<li><a href='http://lisatiy.com'>博客</a></li>
<li><a href='/index.html'>Wiki目录</a></li>
</ul>
</div>")
      (defvar lisatiy-website-html-blog-head
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"/css/worg.css\"/>")
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               ...
               :recursive t
               :html-head , lisatiy-website-html-blog-head
      ...
      ;; used by lisatiy/org-clock-sum-today-by-tags
...
(defun lisatiy-org/init-org-mac-link ()
...
(defun lisatiy-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun lisatiy-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun lisatiy-org/init-ob-typescript ()
  (use-package ob-typescript
    :init))

(defun lisatiy-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun lisatiy-org/post-init-deft ()
  (progn
...
(defun lisatiy-org/init-sound-wav ()
