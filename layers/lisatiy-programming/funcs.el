...
(defun lisatiy/js2-which-function ()
...
(defun lisatiy/run-current-file ()
...
(defun my-setup-develop-environment ()
  (interactive)
  (when (my-project-name-contains-substring "shufei")
    (cond
...
(defun lisatiy-refresh-imenu-index ()
  (interactive)
