;;; packages.el --- lisatiy Layer packages File for Spacemacs
;;
...
(setq lisatiy-programming-packages
      '(
        css-mode
        paredit
        lispy
...
(defun lisatiy-programming/post-init-typescript-mode ()
  (add-hook 'typescript-mode-hook 'my-ts-mode-hook))

(defun lisatiy-programming/post-init-lsp-mode ()
  (progn
    ...
    (add-hook 'lsp-after-open-hook 'lisatiy-refresh-imenu-index)
...
(defun lisatiy-programming/init-compile-dwim ()
  (use-package compile-dwim
    :commands (compile-dwim-run compile-dwim-compile)
    :init))


(defun lisatiy-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun lisatiy/ruby-send-current-line (&optional print)
    ...
    (defun lisatiy/ruby-send-current-line-and-go ()
      (interactive)
      (lisatiy/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun lisatiy/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'lisatiy/ruby-send-current-line
        "sL" 'lisatiy/ruby-send-current-line-and-go
        "sI" 'lisatiy/start-inf-ruby-and-robe))))

(defun lisatiy-programming/init-caps-lock ()
  (use-package caps-lock
    :init
    (progn
      (bind-key* "s-e" 'caps-lock-mode))))

(defun lisatiy-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (lisatiy/git-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun lisatiy-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun lisatiy/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'lisatiy/cider-figwheel-repl))

(defun lisatiy-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun lisatiy-programming/post-init-dumb-jump ()
...
(defun lisatiy-programming/post-init-clojure-mode ()
  )

(defun lisatiy-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun lisatiy-programming/post-init-python ()
...
(defun lisatiy-programming/init-ctags-update ()
...
;; (defun lisatiy-programming/init-js-comint ()
...
(defun lisatiy-programming/post-init-web-mode ()
...
(defun lisatiy-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'lisatiy/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun lisatiy-programming/post-init-racket-mode ()
  (progn
...
(defun lisatiy-programming/post-init-json-mode ()
...
(defun lisatiy-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun lisatiy-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun lisatiy-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun lisatiy-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun lisatiy-programming/post-init-cmake-mode ()
  (progn
...
(defun lisatiy-programming/post-init-flycheck ()
...
(defun lisatiy-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun lisatiy-programming/post-init-js2-refactor ()
  (progn
...
(defun lisatiy-programming/post-init-js2-mode ()
  (progn
...
(defun lisatiy-programming/post-init-css-mode ()
  (progn
...
(defun lisatiy-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function lisatiy/init-<extension-name>
;;
(defun lisatiy-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun lisatiy-programming/init-nodejs-repl-eval ()
...
(defun lisatiy-programming/post-init-lua-mode ()
  (progn
...
(defun lisatiy-programming/post-init-cc-mode ()
  (progn
...
(defun lisatiy-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun lisatiy-programming/post-init-ycmd ()
  (progn
    ...
    (lisatiy|toggle-company-backends company-ycmd)
    (eval-after-load 'ycmd
      '(spacemacs|hide-lighter ycmd-mode))

    (spacemacs/set-leader-keys-for-major-mode 'c-mode
      "tb" 'lisatiy/company-toggle-company-ycmd)
    (spacemacs/set-leader-keys-for-major-mode 'c++-mode
      "tb" 'lisatiy/company-toggle-company-ycmd)))

;; when many project has the need to use tags, I will give etags-table and etags-update a try
(defun lisatiy-programming/init-etags-select ()
...
(defun lisatiy-programming/init-gulpjs ()
  (use-package gulpjs
    :init
    (progn
      (defun lisatiy/build-engine ()
        (interactive)
        (gulpjs-start-task-with-file-name "~/Github/fireball/app.js"))

      (spacemacs/set-leader-keys "ags" 'gulpjs-start-task)
      (spacemacs/set-leader-keys "agS" 'lisatiy/build-engine)
      (spacemacs/set-leader-keys "agr" 'gulpjs-restart-task))))


(defun lisatiy-programming/init-paredit ()
  (use-package paredit
...
(defun lisatiy-programming/post-init-company ()
  (progn
...
(defun lisatiy-programming/post-init-company-c-headers ()
  (progn
