...
(defun lisatiy-ui/post-init-diminish ()
  (progn
...
(defun lisatiy-ui/post-init-spaceline ()
...
(defun lisatiy-ui/init-evil-vimish-fold ()
...
(defun lisatiy-ui/post-init-hl-anything ()
  (progn
...
(defun lisatiy-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun lisatiy-ui/post-init-popwin ()
  (progn
    ;FIXME: 
    ;; (push "*lisatiy/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun lisatiy-ui/post-init-whitespace ()
  (progn
