;;; keybindings.el --- lisatiy Layer packages File for Spacemacs
;;
...
(global-set-key [(shift return)] 'lisatiy/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "<f8>") 'lisatiy/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'lisatiy/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'lisatiy/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'lisatiy/iterm-shell-command))
...
;; (bind-key* "s-r" 'lisatiy/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'lisatiy/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'lisatiy/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'lisatiy/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'lisatiy/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'lisatiy/insert-chrome-current-tab-url)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'lisatiy/goto-match-paren)
(bind-key* "C-c k" 'which-key-show-top-level)
(bind-key* "s-y" 'aya-expand)
(bind-key* "C-." 'lisatiy/insert-space-after-point)
...
(global-set-key (kbd "<f1>") 'lisatiy/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'lisatiy/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
;; (spacemacs/set-leader-keys "op" 'lisatiy/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'lisatiy/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "ok" 'lisatiy-kill-other-persp-buffers)
(spacemacs/set-leader-keys "ox" 'org-open-at-point-global)
(spacemacs/set-leader-keys "or" 'lisatiy/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'lisatiy/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'lisatiy/load-my-layout)
(spacemacs/set-leader-keys "ols" 'lisatiy/save-my-layout)
...
;; highlight
(spacemacs/set-leader-keys "hh" 'lisatiy/highlight-dwim)
(spacemacs/set-leader-keys "hc" 'lisatiy/clearn-highlight)
